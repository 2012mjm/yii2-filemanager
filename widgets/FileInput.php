<?php
namespace mjm\filemanager\widgets;

use Yii;
use yii\helpers\Html;
use yii\widgets\InputWidget;
use mjm\filemanager\assets\FileInputAsset;
use yii\helpers\Url;
 ...
 * More samples of usage see on github: https://github.com/mjm/yii2-filemanager
 *
 * @package mjm\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/mjm/yii2-filemanager/views/file/modal.php', [
